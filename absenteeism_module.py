...
class absenteeism_model:
        ...
        def load_and_clean_data(self, data_file):
            ...
            # to avoid multicollinearity, drop the 'Reason for Absence' column from df as we have created dummies
            ...
            # create a new feature called 'Day of the Week' and pass it to a lambda function returning the day of
            # the week
